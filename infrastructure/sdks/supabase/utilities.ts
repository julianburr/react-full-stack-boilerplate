...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("supabase");
			params.setVersion("1.6.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3N1cGFiYXNlL3N1cGFiYXNlIiwidmVyc2lvbiI6IjEuNi4xIn19"), c => c.charCodeAt(0)));
